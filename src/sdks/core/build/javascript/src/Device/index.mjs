...
registerEvents('Device', Object.values(["deviceNameChanged","nameChanged","hdcpChanged","hdrChanged","audioChanged","screenResolutionChanged","videoResolutionChanged","networkChanged"]))
...
function version() {
  return new Promise( (resolve, reject) => {
      Transport.send('device', 'version').then( v => {
          ...
          v.sdk.minor = parseInt('10')
          v.sdk.patch = parseInt('0')
          v.sdk.readable = 'Device 0.0.0-next.9'
          resolve(v)    
      }).catch(error => {
          reject(error)
      })
