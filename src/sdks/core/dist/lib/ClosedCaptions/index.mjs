...
function enabled() {
  ...
  return Prop.prop('closedcaptions',  'enabled', {  }, callbackOrValue, false, true, 0)
}
function fontFamily() {
  const callbackOrValue = arguments[0]
  return Prop.prop('closedcaptions',  'fontFamily', {  }, callbackOrValue, false, true, 0)
}
function fontSize() {
  const callbackOrValue = arguments[0]
  return Prop.prop('closedcaptions',  'fontSize', {  }, callbackOrValue, false, true, 0)
}
function fontColor() {
  const callbackOrValue = arguments[0]
  return Prop.prop('closedcaptions',  'fontColor', {  }, callbackOrValue, false, true, 0)
}
function fontEdge() {
  const callbackOrValue = arguments[0]
  return Prop.prop('closedcaptions',  'fontEdge', {  }, callbackOrValue, false, true, 0)
}
function fontEdgeColor() {
  const callbackOrValue = arguments[0]
  return Prop.prop('closedcaptions',  'fontEdgeColor', {  }, callbackOrValue, false, true, 0)
}
function fontOpacity() {
  const callbackOrValue = arguments[0]
  return Prop.prop('closedcaptions',  'fontOpacity', {  }, callbackOrValue, false, true, 0)
}
function backgroundColor() {
  const callbackOrValue = arguments[0]
  return Prop.prop('closedcaptions',  'backgroundColor', {  }, callbackOrValue, false, true, 0)
}
function backgroundOpacity() {
  const callbackOrValue = arguments[0]
  return Prop.prop('closedcaptions',  'backgroundOpacity', {  }, callbackOrValue, false, true, 0)
}
function textAlign() {
  const callbackOrValue = arguments[0]
  return Prop.prop('closedcaptions',  'textAlign', {  }, callbackOrValue, false, true, 0)
}
function textAlignVertical() {
  const callbackOrValue = arguments[0]
  return Prop.prop('closedcaptions',  'textAlignVertical', {  }, callbackOrValue, false, true, 0)
}
