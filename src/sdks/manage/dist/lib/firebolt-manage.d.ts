...
interface ProviderSession {
   ...
   * @param {string} capability The Capability to provide
   * @param {StateLifecycleProvider} provider The object providing the capability interface
   */
  function provide(capability: 'xrn:firebolt:capability:lifecycle:state', provider: StateLifecycleProvider | object): Promise<void>
