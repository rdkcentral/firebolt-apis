...
registerProviderInterface('xrn:firebolt:capability:token:session', 'Account', [{"name":"session","focus":true,"response":true,"parameters":false}])
...
function session(token, expiresIn) {
  ...
  function provide(capability, provider) {
    ...
    function listen(...args) {
      return Events.listen('account', ...args)
    } 
    
    function once(...args) {
      return Events.once('account', ...args)
    }
    
    function clear(...args) {
      return Events.clear('account', ...args)
    }
