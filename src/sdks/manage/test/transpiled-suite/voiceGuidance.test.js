...
test("VoiceGuidance.speed()", () => {
    return VoiceGuidance.speed().then((res) => {
        expect(res > 0).toBe(true);
    });
});
test("VoiceGuidance.listen() for enabledChanged event", () => {
    return VoiceGuidance.listen("enabledChanged", () => { }).then((res) => {
        expect(res > 0).toBe(true);
    });
});
test("VoiceGuidance.once() for enabledChanged event", () => {
    return VoiceGuidance.once("enabledChanged", () => { }).then((res) => {
        expect(res > 0).toBe(true);
    });
});
test("VoiceGuidance.listen() for speedChanged event", () => {
    return VoiceGuidance.listen("speedChanged", () => { }).then((res) => {
        expect(res > 0).toBe(true);
    });
});
test("VoiceGuidance.once() for speedChanged event", () => {
    return VoiceGuidance.once("speedChanged", () => { }).then((res) => {
        expect(res > 0).toBe(true);
    });
});
