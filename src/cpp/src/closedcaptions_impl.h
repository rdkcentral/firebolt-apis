...
public:
    ...
    Result<float> backgroundOpacity() const override;
    ...
    Result<float> fontOpacity() const override;
    ...
    Result<float> windowOpacity() const override;

    Result<void> setBackgroundColor(const std::string& value) override;
    Result<void> setBackgroundOpacity(const float value) override;
    ...
    Result<void> setFontOpacity(const float value) override;
    ...
    Result<void> setWindowOpacity(const float value) override;

    // Events
    Result<SubscriptionId>
    subscribeOnBackgroundColorChanged(std::function<void(const std::string&)>&& notification) override;
    Result<SubscriptionId> subscribeOnBackgroundOpacityChanged(std::function<void(float)>&& notification) override;
    ...
    Result<SubscriptionId> subscribeOnFontOpacityChanged(std::function<void(float)>&& notification) override;
    ...
    Result<SubscriptionId> subscribeOnWindowOpacityChanged(std::function<void(float)>&& notification) override;
