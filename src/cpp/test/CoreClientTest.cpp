...
void CoreClientTest::GetDeviceName()
{
...
void CoreClientTest::GetDeviceVersion()
{
    auto version = Firebolt::IFireboltAccessor::Instance().DeviceInterface().version();

    if (version)
    {
        cout << "Get Device Version = " << version->sdk.major << "." << version->sdk.minor << "."
...
void CoreClientTest::SubscribeDeviceNameChanged()
{
...
void CoreClientTest::UnsubscribeDeviceNameChanged()
{
...
void CoreClientTest::GetDeviceModel()
{
...
void CoreClientTest::GetDeviceSku()
{
...
void CoreClientTest::GetDeviceAudio()
{
...
void CoreClientTest::SubscribeDeviceAudioChanged()
{
...
void CoreClientTest::UnsubscribeDeviceAudioChanged()
{
...
void CoreClientTest::GetDeviceScreenResolution()
{
...
void CoreClientTest::SubscribeDeviceScreenResolutionChanged()
{
...
void CoreClientTest::UnsubscribeDeviceScreenResolutionChanged()
{
